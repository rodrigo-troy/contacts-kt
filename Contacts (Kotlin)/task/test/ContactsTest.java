...
public class ContactsTest extends StageTest<TestClue> {
    ...
    private TestCase<TestClue> testPhoneNumber(String num,
                                               boolean isCorrect,
                                               boolean giveHint) {
    ...
    public List<TestCase<TestClue>> generate() {
        return List.of(
                ...
                testPhoneNumber("123",
                                true,
                                true),
                testPhoneNumber("123 abc",
                                true,
                                true),
                testPhoneNumber("123-ABC",
                                true,
                                true),
                testPhoneNumber("123 456 xyz",
                                true,
                                true),
                testPhoneNumber("123-456-XYZ",
                                true,
                ...
                testPhoneNumber("9",
                                true,
                                true),
                testPhoneNumber("123 456 9",
                                false,
                                true),
                testPhoneNumber("123 9 9234",
                                false,
                                true),
                testPhoneNumber("123 4?5 678",
                                false,
                                true),
                testPhoneNumber("+(with space)",
                                false,
                                true),
                ...
                testPhoneNumber("193",
                                true,
                                false),
                testPhoneNumber("129 abf",
                                true,
                                false),
                testPhoneNumber("123-AFC",
                                true,
                                false),
                testPhoneNumber("154 456 xyz",
                                true,
                                false),
                testPhoneNumber("123-566-XYZ",
                                true,
                                false),
                testPhoneNumber("123 456-349",
                                true,
                                false),
                testPhoneNumber("134-456 789",
                                true,
                                false),
                testPhoneNumber("123 45-down-89",
                                true,
                                false),
                ...
                testPhoneNumber("(234)",
                                true,
                                false),
                testPhoneNumber("(123) 566",
                                true,
                                false),
                testPhoneNumber("873-(456)",
                                true,
                                false),
                testPhoneNumber("123 (786) 789",
                                true,
                                false),
                testPhoneNumber("163-(456)-789",
                                true,
                                false),
                testPhoneNumber("(123) 496-789",
                                true,
                                false),
                testPhoneNumber("(173)-456 789",
                                true,
                                false),
                testPhoneNumber("123 (95)-67-89",
                                true,
                                false),
                testPhoneNumber("+(another)",
                                true,
                                false),

                testPhoneNumber("132+456 78912",
                                false,
                                false),
                testPhoneNumber("(123)-456-(45912)",
                                false,
                                false),
                testPhoneNumber("8",
                                true,
                                false),
                testPhoneNumber("153 456 9",
                                false,
                                false),
                testPhoneNumber("823 9 9234",
                                false,
                                false),
                testPhoneNumber("123 4?5 654",
                                false,
                                false),
                testPhoneNumber("+(another space)",
                                false,
                                true),
